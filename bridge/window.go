...
import (
	...
	"github.com/progrium/macdriver/bridge/types"
...
func (w *Window2) Discard(target objc.Object) error {
	obj := cocoa.NSWindow{Object: target}
	obj.Close()
	return nil
}

func (w *Window2) Apply(target objc.Object) error {
