...
//
// [Full Topic]: https://developer.apple.com/documentation/corelocation/cllocationmanager/1423502-headingavailable?language=objc
func (lc _LocationManagerClass) HeadingAvailable() bool {
	rv := objc.Call[bool](lc, objc.Sel("headingAvailable"))
	return rv
}
...
func LocationManager_HeadingAvailable() bool {
	return LocationManagerClass.HeadingAvailable()
}
...
//
// [Full Topic]: https://developer.apple.com/documentation/corelocation/cllocationmanager/1423648-locationservicesenabled?language=objc
func (lc _LocationManagerClass) LocationServicesEnabled() bool {
	rv := objc.Call[bool](lc, objc.Sel("locationServicesEnabled"))
	return rv
}
...
//
// [Full Topic]: https://developer.apple.com/documentation/corelocation/cllocationmanager/3600217-requesttemporaryfullaccuracyauth?language=objc
func (l_ LocationManager) RequestTemporaryFullAccuracyAuthorizationWithPurposeKeyCompletion(purposeKey string, completion func(arg0 foundation.Error)) {
	objc.Call[objc.Void](l_, objc.Sel("requestTemporaryFullAccuracyAuthorizationWithPurposeKey:completion:"), purposeKey, completion)
}
...
func (l_ LocationManager) Delegate() LocationManagerDelegateObject {
	rv := objc.Call[LocationManagerDelegateObject](l_, objc.Sel("delegate"))
	return rv
}
