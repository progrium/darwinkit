...
func ScrubberSelectionView_InitWithFrame(frameRect foundation.Rect) ScrubberSelectionView {
	return ScrubberSelectionViewClass.Alloc().InitWithFrame(frameRect)
}
