...
func CustomTouchBarItem_InitWithIdentifier(identifier TouchBarItemIdentifier) CustomTouchBarItem {
	return CustomTouchBarItemClass.Alloc().InitWithIdentifier(identifier)
}
