...
type PCustomLayer interface {
	...
	// optional
	OutputShapesForInputShapesError(inputShapes [][]foundation.Number, error foundation.Error) [][]foundation.Number
	HasOutputShapesForInputShapesError() bool

	// optional
	InitWithParameterDictionaryError(parameters map[string]objc.Object, error foundation.Error) objc.Object
	HasInitWithParameterDictionaryError() bool

	// optional
	EncodeToCommandBufferInputsOutputsError(commandBuffer metal.CommandBufferObject, inputs []metal.TextureObject, outputs []metal.TextureObject, error foundation.Error) bool
...
func (c_ CustomLayerObject) EvaluateOnCPUWithInputsOutputsError(inputs []MultiArray, outputs []MultiArray, error foundation.Error) bool {
...
func (c_ CustomLayerObject) OutputShapesForInputShapesError(inputShapes [][]foundation.Number, error foundation.Error) [][]foundation.Number {
...
func (c_ CustomLayerObject) InitWithParameterDictionaryError(parameters map[string]objc.Object, error foundation.Error) objc.Object {
...
func (c_ CustomLayerObject) EncodeToCommandBufferInputsOutputsError(commandBuffer metal.CommandBufferObject, inputs []metal.TextureObject, outputs []metal.TextureObject, error foundation.Error) bool {
...
func (c_ CustomLayerObject) SetWeightDataError(weights [][]byte, error foundation.Error) bool {
