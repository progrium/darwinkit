...
var _ PPlayerItemMetadataCollectorPushDelegate = (*PlayerItemMetadataCollectorPushDelegateObject)(nil)

// A concrete type for the [PPlayerItemMetadataCollectorPushDelegate] protocol.
type PlayerItemMetadataCollectorPushDelegateObject struct {
	objc.Object
}

func (p_ PlayerItemMetadataCollectorPushDelegateObject) HasMetadataCollectorDidCollectDateRangeMetadataGroupsIndexesOfNewGroupsIndexesOfModifiedGroups() bool {
