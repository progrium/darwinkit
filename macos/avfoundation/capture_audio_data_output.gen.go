...
type ICaptureAudioDataOutput interface {
	...
	SampleBufferDelegate() CaptureAudioDataOutputSampleBufferDelegateObject
}
...
func (c_ CaptureAudioDataOutput) SampleBufferDelegate() CaptureAudioDataOutputSampleBufferDelegateObject {
	rv := objc.Call[CaptureAudioDataOutputSampleBufferDelegateObject](c_, objc.Sel("sampleBufferDelegate"))
	return rv
}
