...
var _ PCaptureFileOutputDelegate = (*CaptureFileOutputDelegateObject)(nil)

// A concrete type for the [PCaptureFileOutputDelegate] protocol.
type CaptureFileOutputDelegateObject struct {
	objc.Object
}

func (c_ CaptureFileOutputDelegateObject) HasCaptureOutputShouldProvideSampleAccurateRecordingStart() bool {
...
func (c_ CaptureFileOutputDelegateObject) HasCaptureOutputDidOutputSampleBufferFromConnection() bool {
