...
func setupGL() error {
	ctx := objc.CallMethod[objc.Object](view, objc.GetSelector("openGLContext"))
	objc.CallMethod[objc.Void](ctx, objc.GetSelector("makeCurrentContext"))
	err := gl.Init()
	if err != nil {
		return err
	}
...
func renderGL(view appkit.View) bool {
