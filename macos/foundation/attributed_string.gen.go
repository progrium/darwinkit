...
func (a_ AttributedString) InitWithHTMLBaseURLDocumentAttributes(data []byte, base IURL, dict Dictionary) AttributedString {
	rv := objc.Call[AttributedString](a_, objc.Sel("initWithHTML:baseURL:documentAttributes:"), data, objc.Ptr(base), dict)
	return rv
}
...
func NewAttributedStringWithHTMLBaseURLDocumentAttributes(data []byte, base IURL, dict Dictionary) AttributedString {
...
func (ac _AttributedStringClass) LocalizedAttributedStringWithFormatOptions(format IAttributedString, options AttributedStringFormattingOptions, args ...any) AttributedString {
	rv := objc.Call[AttributedString](ac, objc.Sel("localizedAttributedStringWithFormat:options:"), append([]any{objc.Ptr(format), options}, args...)...)
	return rv
}
...
func (a_ AttributedString) InitWithURLOptionsDocumentAttributesError(url IURL, options Dictionary, dict Dictionary, error IError) AttributedString {
	rv := objc.Call[AttributedString](a_, objc.Sel("initWithURL:options:documentAttributes:error:"), objc.Ptr(url), options, dict, objc.Ptr(error))
	return rv
}
...
func NewAttributedStringWithURLOptionsDocumentAttributesError(url IURL, options Dictionary, dict Dictionary, error IError) AttributedString {
	instance := AttributedStringClass.Alloc().InitWithURLOptionsDocumentAttributesError(url, options, dict, error)
	instance.Autorelease()
	return instance
}

func (a_ AttributedString) InitWithHTMLDocumentAttributes(data []byte, dict Dictionary) AttributedString {
...
func NewAttributedStringWithHTMLDocumentAttributes(data []byte, dict Dictionary) AttributedString {
...
func (a_ AttributedString) BoundingRectWithSizeOptionsContext(size Size, options objc.IObject, context objc.IObject) Rect {
	rv := objc.Call[Rect](a_, objc.Sel("boundingRectWithSize:options:context:"), size, objc.Ptr(options), objc.Ptr(context))
	return rv
}
...
func (a_ AttributedString) DrawWithRectOptionsContext(rect Rect, options objc.IObject, context objc.IObject) {
	objc.Call[objc.Void](a_, objc.Sel("drawWithRect:options:context:"), rect, objc.Ptr(options), objc.Ptr(context))
}
