...
func AccelerationStructureMotionTriangleGeometryDescriptor_Alloc() AccelerationStructureMotionTriangleGeometryDescriptor {
	return AccelerationStructureMotionTriangleGeometryDescriptorClass.Alloc()
}
...
func (a_ AccelerationStructureMotionTriangleGeometryDescriptor) IndexBuffer() BufferWrapper {
