...
func RenderPassAttachmentDescriptor_Alloc() RenderPassAttachmentDescriptor {
	return RenderPassAttachmentDescriptorClass.Alloc()
}
...
func (r_ RenderPassAttachmentDescriptor) ResolveTexture() TextureWrapper {
	rv := objc.Call[TextureWrapper](r_, objc.Sel("resolveTexture"))
	return rv
}
...
func (r_ RenderPassAttachmentDescriptor) Texture() TextureWrapper {
	rv := objc.Call[TextureWrapper](r_, objc.Sel("texture"))
	return rv
}
