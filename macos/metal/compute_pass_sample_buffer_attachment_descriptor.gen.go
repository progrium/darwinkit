...
func ComputePassSampleBufferAttachmentDescriptor_Alloc() ComputePassSampleBufferAttachmentDescriptor {
	return ComputePassSampleBufferAttachmentDescriptorClass.Alloc()
}
...
func (c_ ComputePassSampleBufferAttachmentDescriptor) SampleBuffer() CounterSampleBufferWrapper {
	rv := objc.Call[CounterSampleBufferWrapper](c_, objc.Sel("sampleBuffer"))
	return rv
}
